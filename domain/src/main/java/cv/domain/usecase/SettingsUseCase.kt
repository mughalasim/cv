...
class SettingsUseCase(
    ...
    fun setExpandListOnStartUp(isEnabled: Boolean) {
        analyticsRepository.logEvent(EVENT_NAME_SETTING, listOf(Pair(PARAM_EXPAND_LIST_ON_START_UP, isEnabled.toString())))
    ...
    fun setListOrientation(isVertical: Boolean){
        analyticsRepository.logEvent(EVENT_NAME_SETTING, listOf(Pair(PARAM_MAIN_SCREEN_ORIENTATION, isVertical.toString())))
